...
local function base_layers()
    return
    {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-base",
        {
        ...
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-base-shadow",
        {
            animation_speed = animation_speed,
            draw_as_shadow = true,
            frame_count = 1,
...
local function warm_up_animation(frame_count)
    return {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-main-warm-up",
        {
            animation_speed = animation_speed,
        ...
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-shadow-warm-up",
        {
            draw_as_shadow = true,
            animation_speed = animation_speed,
            frame_count = frame_count or warm_up_frames,
...
local function rotate_animation()
    return {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-main-rotate",
        {
            animation_speed = animation_speed,
        ...
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-shadow-rotate",
        {
            draw_as_shadow = true,
            animation_speed = animation_speed,
            frame_count = rotate_frames,
...
local function rotate_continue_animation()
    return {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-main-rotate-continue",
        {
            animation_speed = animation_speed,
        ...
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-shadow-rotate-continue",
        {
            draw_as_shadow = true,
            animation_speed = animation_speed,
            frame_count = rotate_continue_frames,
...
local function cool_down_animation(frame_count)
    return {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-main-cool-down",
        {
            animation_speed = animation_speed,
        ...
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-shadow-cool-down",
        {
            draw_as_shadow = true,
            animation_speed = animation_speed,
            frame_count = frame_count or cool_down_frames,
...
local function lights_warm_up_animation()
    return {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-lights-warm-up",
        {
            draw_as_glow = true,
            blend_mode = "additive",
            animation_speed = animation_speed,
...
local function lights_rotate_animation()
    return {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-lights-rotate",
        {
            draw_as_glow = true,
            blend_mode = "additive",
            animation_speed = animation_speed,
...
local function lights_rotate_continue_animation()
    return {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-lights-rotate-continue",
        {
            draw_as_glow = true,
            blend_mode = "additive",
            animation_speed = animation_speed,
...
local function lights_cool_down_animation(frame_count)
    return {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-lights-cool-down",
        {
            draw_as_glow = true,
            blend_mode = "additive",
            animation_speed = animation_speed,
...
local function pipe_connection(pipe_direction)
    ...
    {
        layers = {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/pipe-connections/electromagnetic-plant-pipe-" .. pipe_direction,
            {
            scale = 0.5,
            }
        ),
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/pipe-connections/electromagnetic-plant-pipe-" .. pipe_direction_shadow,
            {
            scale = 0.5,
            draw_as_shadow = true,
            }
...
local function pipe_connection_frozen(pipe_direction)
    ...
    {
        layers = {
        util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/pipe-connections/electromagnetic-plant-pipe-" .. pipe_direction.."-frozen",
            {
            scale = 0.5,
            }
        )
...
return
{
    graphics_set = {
        ...
        frozen_patch = util.sprite_load("__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-frozen", {scale = 0.5}),
        reset_animation_when_frozen = true
    },
    water_reflection = {
        pictures =
        {
        filename = "__se-ssa-i__/graphics/entity/electromagnetic-plant/electromagnetic-plant-water-reflection.png",
        width = 26,
        height = 34,
